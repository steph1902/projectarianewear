...
<th>Coupon Discount Value</th> --}}
          ...
          <form method="post" action="{{action('BackendController@backendEditCoupon')}}">
            @csrf
            ...
            <input type="number" value="{{$coupon->coupon_discount_value}}" name="coupon_discount_value" class="form-control" placeholder="1..99 %">
            </div>
